...
Cloudflare Pages Functions for the branded site: /randevu issues a 302 to Google Calendar (no booking logic), /listeden-cik proxies email opt-out to the Twilio upstream with no local suppression store. Both fail with Turkish fallback pages, never false success.
