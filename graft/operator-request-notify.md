...
sources_digest: 8e026a3fe67d983c691aa55f62be57d3036735e2371063b2462835eb4a5203bb
links:
  - to: cockpit-server
    relation: depends_on
    description: >-
      Depends on the exact append layout server.py writes to
...
Regex-based window parser over memories/operator-decisions.md, whose layout is load-bearing (the cockpit server appends decisions in a specific format).

## Related

- depends on [[cockpit-server]] — Depends on the exact append layout server.py writes to operator-decisions.md.
