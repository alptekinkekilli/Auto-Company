...
opportunity-analyst-jcode.sh runs the analyst jcode cycle with provider-specific effort env vars, dedupes session IDs into a log, and writes the report header naming the model.
