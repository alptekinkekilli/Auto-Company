---
name: G4 identity-attribution evidence
slug: g4-identity-attribution-evidence
type: system
sources:
...
sources_digest: 517c58378c9ee58eac3d0571c1178988a45ed92ee8d2e6b903fe9a97cb450ad3
links:
  - to: airtable-access-wrappers
    relation: uses
    description: >-
      g4-check reads the Registry Bridge table and send-gate re-derives G4 by
      importing g4-check.
generator:
  version: 1
covers:
...
Deterministic evidence gathering for G4 identity attribution of Turkish firms: site-contact-evidence finds published contact emails (inconclusive never negative), g4-check tests a row's claim against live evidence, and kik-decision-read digests procurement pages. All reuse the render-first examiner and Turkish-aware normalization.

## Related

- uses [[airtable-access-wrappers]] — g4-check reads the Registry Bridge table and send-gate re-derives G4 by importing g4-check.
