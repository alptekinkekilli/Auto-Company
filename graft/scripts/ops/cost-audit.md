...
- build_report · function · L148-L288 — Assembles the full markdown cost-audit report from ledger, loop, jcode, and inventory data, reporting on the previous completed UTC day.
- main · function · L291-L309 — Parses CLI args, builds the report, and atomically writes it to the output file via a temp file and os.replace.
