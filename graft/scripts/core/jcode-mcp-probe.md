# scripts/core/jcode-mcp-probe.py · [[atomic-write-and-compare-and-swap-discipline]] [[fail-open-vs-fail-closed-operational-philosophy]] [[mcp-config-generation-and-probe]] [[mcp-configuration-and-probe]]
