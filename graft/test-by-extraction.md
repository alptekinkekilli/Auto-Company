---
name: Test-by-Extraction
slug: test-by-extraction
type: concept
sources:
...
sources_digest: 0f8ae981b28d19a0a68220c41ac8e76bb6160312003dffa3725fb79a69d198dc
links:
  - to: auto-loop-core
    relation: validates
    description: Extracts and drives auto-loop.sh functions.
generator:
  version: 1
covers:
...
The dominant testing strategy: tests extract real function bodies from shipping scripts via awk (or importlib for Python) and drive them in isolated sandboxes, so tests exercise the shipping code rather than copies. This catches raw-quote and set -e regressions that bash -n cannot.

## Related

- validates [[auto-loop-core]] — Extracts and drives auto-loop.sh functions.
