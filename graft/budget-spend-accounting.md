...
sources_digest: c05688e11ac1fd5140a1b5f3a6b3b1bf341c03b0e974c492a1ba43a852373c03
links:
...
Spend measurement and gating across engines: ccusage reads, TOTAL_SPEND_LEDGER rows, discretionary daily cap, and the 15 APP-263 budget gates. Fail-closed: a first-ever ccusage failure latches a hold and returns NA, degraded reads never overwrite the cache, and spend is summed from two disjoint sources (ccusage + ledger) rather than maxed.

## Related

- part of [[auto-loop-core-engine]]
- uses [[cycle-metadata-cost-attribution]]
