---
name: Dashboard & runtime telemetry
slug: dashboard-runtime-telemetry
type: system
sources:
  ...
  - path: tests/test_dashboard_server.py
    hash: 946172a72f08e1de0f76824652adfb2be847825b499c86465b4ce46412e2ebcc
sources_digest: f7617afc27e62965a2643e229d1572937a6077144dab803a422491ef46e4759c
links:
  - to: budget-spend-accounting
    relation: uses
    description: read_cost_summary mirrors the loop's blockStart weekly window
generator:
  version: 1
covers:
  - symbol: ps_quote
...
Serves operator status from the ever-growing auto-loop.log, parsing the latest boot (not first match), escalated model from [ESCALATE] line, and spend windows anchored on ccusage blockStart with now-5h fallback.

## Related

- uses [[budget-spend-accounting]] — read_cost_summary mirrors the loop's blockStart weekly window
