---
name: SnapOG north-star metric (WAP)
slug: snapog-north-star-metric-wap
type: concept
sources:
...
links:
  - to: snapog-d1-schema
    relation: depends_on
    description: Queries usage_events and api_keys per the 0001_init.sql schema.
generator:
  version: 1
covers: []
---
