---
name: HeadInspect Renderer
slug: headinspect-renderer
type: file
sources:
...
links:
  - to: headinspect-worker
    relation: part_of
    description: Rendering module used by the worker.
generator:
  version: 1
covers:
  - symbol: escapeHtml
