---
name: Registry and browse tooling
slug: registry-and-browse-tooling
type: system
sources:
...
sources_digest: 0061f4c231e1c3ae50e5d1a918ddf3a2b37f24e71907604ae3fecb09f61a660e
links:
...
registry-archive.py archives stale dated sections while preserving a protected live span, and browse-extract.py extracts browser content via MCP with guaranteed tab-close on all paths.

## Related

- uses [[mcp-configuration-and-key-security]] — browse-extract.py talks to the browseros MCP server.
