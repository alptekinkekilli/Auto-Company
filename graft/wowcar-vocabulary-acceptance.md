---
name: wowcar-vocabulary-acceptance
slug: wowcar-vocabulary-acceptance
type: system
sources:
...
Acceptance test for the WowCar revenue vocabulary: verifies the candidate vocabulary (fixed to projects/wowcar/generator-source/kod) either remains unchanged or contains exactly 14 anchor terms. The shell harness standardizes invocation, requiring the mode to be exactly 'unchanged' or '14-anchor' and an absolute report path if provided.
