...
Implements the turn-economy policy (section 4): parses daily-log sessions, counts turns/messages, accounts for cache, and applies verdict thresholds (CHATTY, BLOATED, ok) with a --summary-last flag selecting the newest session. Boundary values (55 vs 56 turns, 66 turns, duration-based bloating) are pinned to prevent silent recalibration drift.
