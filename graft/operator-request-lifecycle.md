---
name: Operator request lifecycle
slug: operator-request-lifecycle
type: system
sources:
...
sources_digest: e1617b66aea781197cff70ffa2e861318e185ee9e09aadca3907555b0e0e4c33
links:
  - to: auto-loop-core-engine
    relation: uses
    description: OPREQ ledger step runs before idle-skip sleep
generator:
  version: 1
covers:
...
Notifies and resolves operator requests stored in memories/operator-requests.md. Notifies exactly once via sha256 content fingerprints, never notifies HOLD/informational/research-result types, retries Telegram failures without marking notified, and enforces per-type resolution evidence (checksum-matched files, structured Decision/Authorization lines).

## Related

- uses [[auto-loop-core-engine]] — OPREQ ledger step runs before idle-skip sleep
