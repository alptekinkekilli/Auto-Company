...
- [airtable-access-wrappers](airtable-access-wrappers.md) — Airtable access wrappers · scripts/ops/airtable-read.py, scripts/ops/airtable-write.py, scripts/ops/send-gate.py
- [atomic-state-writes](atomic-state-writes.md) — atomic state writes · scripts/core/jcode-mcp-config.py, scripts/core/operator_request_notify.py, scripts/ops/idle-skip-note.py, scripts/ops/registry-archive.py, scripts/ops/state-snapshot.py, scripts/ops/tool-usage-audit.py
...
- [cost-budget-reporting](cost-budget-reporting.md) — cost & budget reporting · scripts/ops/bloat-trend.py, scripts/ops/budget-calibration-report.py, scripts/ops/cost-audit.py, scripts/ops/operator-usage-report.sh
...
- [docker-host-hygiene](docker-host-hygiene.md) — docker & host hygiene · scripts/linux/noop-action.sh, scripts/linux/status-linux.sh, scripts/ops/docker-prune-safe.sh
...
- [g4-identity-attribution-evidence](g4-identity-attribution-evidence.md) — G4 identity-attribution evidence · scripts/ops/g4-check.py, scripts/ops/kik-decision-read.py, scripts/ops/site-contact-evidence.py
...
- [loop-lifecycle-monitoring](loop-lifecycle-monitoring.md) — loop lifecycle & monitoring · scripts/core/monitor.sh, scripts/core/sentry-heartbeat.sh, scripts/core/stop-loop.sh, scripts/linux/noop-action.sh, scripts/linux/status-linux.sh, scripts/macos/status-mac.sh
- [macos-daemon-install](macos-daemon-install.md) — macOS daemon install · scripts/macos/install-daemon.sh
- [mcp-boot-config](mcp-boot-config.md) — MCP boot & config · scripts/core/jcode-mcp-config.py, scripts/core/jcode-mcp-probe.py, scripts/ops/verify-mcp-keys.py
...
- [opportunity-analyst-orchestration](opportunity-analyst-orchestration.md) — opportunity analyst orchestration · scripts/ops/opportunity-analyst-cron.sh, scripts/ops/state-snapshot.py
...
- [policy-cutover-splitting](policy-cutover-splitting.md) — policy cutover splitting · scripts/ops/bloat-trend.py, scripts/ops/budget-calibration-report.py, scripts/ops/cost-audit.py
...
- [registry-directive-maintenance](registry-directive-maintenance.md) — registry & directive maintenance · scripts/ops/directive-rule-sweep.py, scripts/ops/directive-staleness-watch.py, scripts/ops/extract-axis-evidence.py, scripts/ops/registry-archive.py
...
- [secret-handling](secret-handling.md) — secret handling · scripts/core/jcode-mcp-config.py, scripts/core/telegram-notify.sh, scripts/ops/airtable-write.py, scripts/ops/linear-track.py, scripts/ops/verify-mcp-keys.py
...
- [workstream-outreach-tooling](workstream-outreach-tooling.md) — workstream & outreach tooling · scripts/ops/browse-extract.py, scripts/ops/kik-decision-read.py, scripts/ops/linear-track.py
