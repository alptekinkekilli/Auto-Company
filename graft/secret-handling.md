...
sources_digest: 32749d56cba22a841096270cc377ad29c11f370be1f9b405c8cc5bcca8a79484
links:
  - to: airtable-access-layer
    relation: implements
    description: >-
      The airtable scripts are the reference implementation of the env/Keychain
      secret resolution.
generator:
  version: 1
covers:
...
Secrets (Airtable, Linear, Telegram, Sentry) are never passed as argv or printed; they come from env, logs/runtime.env, or macOS Keychain. jcode-mcp-config deliberately keeps header secrets unexpanded in argv to avoid ps leaks, and docker-prune-safe avoids dot-sourcing runtime.env because its values contain '|'.

## Related

- implements [[airtable-access-layer]] — The airtable scripts are the reference implementation of the env/Keychain secret resolution.
