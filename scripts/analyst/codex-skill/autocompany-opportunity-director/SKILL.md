...
2. **Outreach is human-gated.** You may never mark a message ready to send, set an Airtable `Email queue` value, propose auto-sending, or recommend removing the human gate. Contact volume and copy may be *analyzed*; dispatch is the operator's.
